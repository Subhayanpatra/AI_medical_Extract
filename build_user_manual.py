...
OUT = ROOT / "AI_Extract_User_Manual_v2.docx"
BLUE = "2E74B5"
DARK = "1F4D78"
LIGHT = "E8EEF5"
PALE = "F4F6F9"
...
font(footer.add_run("Local biomedical evidence extraction platform  |  Version 2.0"), 8.5, False, "666666")
...
p = doc.add_paragraph()
p.alignment = WD_ALIGN_PARAGRAPH.CENTER
font(p.add_run("Documentation date: 27 July 2026"), 10, True, DARK)
...
for item in [
    ...
    "6. Installation and configuration", "7. Data and supplementary files",
...
page_break(doc)
doc.add_heading("6. Installation and configuration", level=1)
...
for text in [
    ...
    "If AI extraction is enabled, each selected paper is downloaded, parsed, supplemented, and analyzed.",
